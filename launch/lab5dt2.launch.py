...
def generate_launch_description():
  ...
  declare_square_routine = DeclareLaunchArgument(
     name='square_routine',
     default_value='true',
     description='run square routine form dt1')
     
  declare_save_map = DeclareLaunchArgument(
     name='save_map',
     default_value='true',
     description='run the map saver')
  ...
  start_save_map = Node(
    ...
    name='mapsaver',
    output= 'screen',
    arguments=['-f','/home/student/ros2_ws/src/eced3901/maps/dt2map'])"""
  ...
  ld.add_action(declare_square_routine)
  ...
  #ld.add_action(TimerAction(period=10.0,actions=[start_square_routine]))
  #ld.add_action(TimerAction(period=80.0,actions=[start_save_map]))
