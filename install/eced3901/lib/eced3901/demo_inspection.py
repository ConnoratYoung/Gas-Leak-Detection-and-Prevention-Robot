...
def main():
    ...
    inspection_route = [
    	[0.0, 0.0, m.pi/2],			# Origin, added a 3rd coordinte for headings
    	[0.0, 1.83+rrad, m.pi/2],		# First Pipe loaction
        [1.22, 2.74+rrad, m.pi/2], 		# In between the wall and deer
        [3.05+rrad, 3.35, m.pi],		# First leak
        [1.22, 2.74-rrad, -m.pi/2],		# Second leak
